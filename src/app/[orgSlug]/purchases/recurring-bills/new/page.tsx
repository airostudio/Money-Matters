...
export default async function NewRecurringBillPage({
  ...
  const boundCreate = createRecurringBillAction.bind(null, org.slug);
    ...
    return (
      <Card className="max-w-lg">
        <CardContent className="space-y-3 p-6 text-sm text-muted-foreground">
          <p>You need at least one supplier before you can create a recurring bill template.</p>
  ...
  return (
    <div className="max-w-3xl">
      <Card>
        <CardHeader>
          <CardTitle>New recurring bill template</CardTitle>
        </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 space-y-2">
                ...
                <Input id="name" name="name" placeholder="e.g. Monthly cleaning service" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="supplierContactId">Supplier</Label>
                <select id="supplierContactId" name="supplierContactId" required className="h-9 w-full rounded-md border border-input bg-background px-3 text-sm">
              ...
              <div className="space-y-2">
                ...
                <select id="frequency" name="frequency" className="h-9 w-full rounded-md border border-input bg-background px-3 text-sm">
              ...
              <div className="space-y-2">
                ...
                <Input id="maxOccurrences" name="maxOccurrences" type="number" min={1} />
              </div>
              <div className="col-span-2 space-y-2">
                <Label htmlFor="memo">Memo</Label>
                <Input id="memo" name="memo" placeholder="Copied onto every generated bill" />
              </div>
            </div>
