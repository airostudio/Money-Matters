...
export default async function NewInvoicePage({
  ...
  const boundCreate = createInvoiceAction.bind(null, org.slug);
    ...
    return (
      <Card className="max-w-lg">
        <CardContent className="space-y-3 p-6 text-sm text-muted-foreground">
          <p>You need at least one customer before you can create an invoice.</p>
  ...
  if (revenueAccounts.length === 0) {
    return (
      <Card className="max-w-lg">
        <CardContent className="space-y-3 p-6 text-sm text-muted-foreground">
          <p>You need at least one revenue account in your chart of accounts before you can create an invoice.</p>
          <Button asChild size="sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 space-y-2">
                ...
                <Input id="memo" name="memo" placeholder="Optional note for this invoice" />
              </div>
            </div>
